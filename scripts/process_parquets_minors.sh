...
do 
	python $EXEDIR/read_parquet.py -v --debug --group minors --config $EXEDIR/secrets_mdb.yml --update $EXEDIR/data/columns_consolidated.tsv $d >> logs/update_dec23_minors.log
done
